...
class ReadMeasurement_SFA3x():
    ...
    def Start_Measurement(self):
        ...
        for channel in range(8): 
            ...
            try: 
                self.OpenChannel_TCA9548(self.address_TCA9548, channel)
                # print(address, channel)
                # time.sleep(0.1)
            except Exception as e: 
                print("OpenChannel_TCA9548 channel error")
                # print(e) 
                pass
            ...
            try:
                ...
                # print(sn)
                self.uart_SNList[str(channel)] =  'port'+str(channel+1)+'_'+sn
                
                self.Write_toFile('#port'+str(channel+1)+' ' +sn)
                
                print("Start_Measurement is done")
        ...
        for channel in range(8):
            ...
            try: 
                ...
                if len(read)==3:
                    ...
                    data_location.append(channel) #remember the location where has data
                    
                    dataJson[str(channel+1)] = read
                    self.uart_Datasend[str(channel)] = read
            except Exception as e:
                # print(e)
                pass
